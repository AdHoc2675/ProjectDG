...
#include "GAS/Abilities/Player/Assassin/GA_Assassin_ShadowAssault.h"
...
UGA_Assassin_ShadowAssault::UGA_Assassin_ShadowAssault()
{
      ...
      AbilityTags.AddTag(DGGameplayTags::Skill_Assassin_ShadowAssault);
      ActivationOwnedTags.AddTag(DGGameplayTags::State_Skill_Assassin_ShadowAssault_Active);
}

void UGA_Assassin_ShadowAssault::EndAbility(
...
void UGA_Assassin_ShadowAssault::ResetTargetMontageState()
{
      ClearIgnoredDashTargetCollision();
...
void UGA_Assassin_ShadowAssault::StartTargetMontageEventTasks()
{
      Super::StartTargetMontageEventTasks();

      MoveBeginTask = UAbilityTask_WaitGameplayEvent::WaitGameplayEvent(
                      this,
                      DGGameplayTags::Event_Movement_Assassin_ShadowAssault_MoveBegin.GetTag(),
                      nullptr,
                      false,
                      true
      );
      ...
      if (MoveBeginTask)
      {
              MoveBeginTask->EventReceived.AddDynamic(
                              this,
                              &UGA_Assassin_ShadowAssault::OnMoveBegin
              );
...
void UGA_Assassin_ShadowAssault::StartMoveBehindTarget(float Duration)
{
      ...
      MoveBehindTargetTask = UAbilityTask_ApplyRootMotionMoveToForce::ApplyRootMotionMoveToForce(
                      this,
                      TEXT("ShadowAssaultMoveBehindTarget"),
      ...
      {
              MoveBehindTargetTask->OnTimedOut.AddDynamic(this, &UGA_Assassin_ShadowAssault::OnMoveFinished);
              MoveBehindTargetTask->OnTimedOutAndDestinationReached.AddDynamic(this, &UGA_Assassin_ShadowAssault::OnMoveFinished);
...
void UGA_Assassin_ShadowAssault::ClearIgnoredDashTargetCollision()
{
      ACharacter* AvatarCharacter = Cast<ACharacter>(GetAvatarActorFromAbility());
