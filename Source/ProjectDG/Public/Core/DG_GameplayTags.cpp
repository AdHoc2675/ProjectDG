...
namespace DGGameplayTags
{
	...
	UE_DEFINE_GAMEPLAY_TAG(Boss_Kashapa_Phase2_Skill1, "Boss.Kashapa.Phase2.SKill1")
	UE_DEFINE_GAMEPLAY_TAG(Boss_Kashapa_Phase2_Skill2, "Boss.Kashapa.Phase2.SKill2")
	UE_DEFINE_GAMEPLAY_TAG(Boss_Kashapa_Phase2_Skill3, "Boss.Kashapa.Phase2.SKill3")
	...
	UE_DEFINE_GAMEPLAY_TAG(Boss_Kashapa_Phase2_Skill8, "Boss.Kashapa.Phase2.SKill8")
	UE_DEFINE_GAMEPLAY_TAG(Boss_Kashapa_Phase2_Skill9, "Boss.Kashapa.Phase2.SKill9")
	UE_DEFINE_GAMEPLAY_TAG(Boss_Kashapa_Phase2_Skill10, "Boss.Kashapa.Phase2.SKill10")
