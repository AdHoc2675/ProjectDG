...
#include "ANS_BossAttackHitWindow.generated.h"

class USkeletalMeshComponent;

struct FBossAttackHitWindowRuntimeData
{
...
/**
 * Boss 전용 공격 히트 윈도우 노티파이.
 * Boss는 무기 메시가 별도 존재하지 않으므로 캐릭터 스켈레탈 메시의 소켓을 직접 트레이스한다.
 */
UCLASS()
class PROJECTDG_API UANS_BossAttackHitWindow : public UAnimNotifyState
{
	GENERATED_BODY()

public:
	UANS_BossAttackHitWindow();
...
private:
	TMap<TWeakObjectPtr<USkeletalMeshComponent>, FBossAttackHitWindowRuntimeData> RuntimeDataMap;
