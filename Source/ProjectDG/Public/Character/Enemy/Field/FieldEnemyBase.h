...
public:
	// Getters / Setters
	FORCEINLINE FVector GetSpawnOriginLocation() const { return SpawnOriginLocation; }
	...
	/** 등록된 공격 스킬 데이터 중 무작위로 하나를 선택하여 반환 */
	UFUNCTION(BlueprintCallable, Category = "FieldEnemy|Skill")
	UEnemySkillData* GetRandomAttackSkillData() const;
	
	/** 구 BTTask 호환용: AttackSkills에서 랜덤 스킬을 뽑고 AbilityClass만 반환 */
...
protected:
	...
	UPROPERTY(VisibleInstanceOnly, BlueprintReadOnly, Category = "FieldEnemy|GAS")
	bool bFieldDataEffectsApplied = false;
};